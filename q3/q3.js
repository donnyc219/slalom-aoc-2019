...
// testing sample
path1 = "R10,U12,R17,D20,R10";
path2 = "U6,R30,D20";

var path1InPoints = turnPathToCoordinatePoints(path1, origin);
var path2InPoints = turnPathToCoordinatePoints(path2, origin);
var intersectionsPoints = findAllIntersectionPointsOfPaths(path1InPoints, path2InPoints);
var map = convertPointsArrayToMap(intersectionsPoints);
findStepsToIntersections(intersectionsPoints, path1InPoints, map, true);
findStepsToIntersections(intersectionsPoints, path2InPoints, map, false);
console.log(map);
